...
const Chat = () => {
  ...
  return (
    <div className="flex flex-col w-full mx-auto border p-4 rounded-lg shadow-lg h-screen">
      {receiverId ? (
        <>
        <div className="h-full overflow-y-auto w-full flex flex-col border-b p-2">
